...
dir = Path("dalleTestShiny.py").resolve().parent
assets = dir / "assets",
css_file = dir / "css" / "styles.css",
img = dir / "assets" / "img",
spaceBackground = dir / "assets" / "img"/ "space-back.svg",
print(str(spaceBackground))
...
app_ui = ui.page_navbar(
    ...
    head_content(
        ...
        tags.style((Path("dalleTestShiny.py").parent / "assets" / "css" / "styles.css").read_text()),
        tags.script((Path("dalleTestShiny.py").parent / "assets" / "js" / "script.js").read_text()),
    ),
    ui.nav(
        "Is Earth in Danger? 🌎 ☄ 😱",
        ui.div(
